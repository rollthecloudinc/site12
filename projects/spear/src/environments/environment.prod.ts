...
export const environment = {
  ...
  site: 'site12',
  apiGatewaySettings: {
    endpointUrl: 'https://edge.hedge.earth/emissionless/rollthecloudinc/site12-objects-prod/shapeshifter',
  },
  mediaSettings: {
    ...
    imageUrl: 'https://edge.hedge.earth/emissionless/site12',
  ...
  panelsSettings: {
    ...
    objectsRootUrl: 'https://rollthecloudinc.github.io/site12-objects-prod'
  },
  alienaliasSettings: {
    openSearchDomain: 'search-classifieds-ui-prod-o5unofrr3c4qb3ykfrxebh2e4a'
  },
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://site12.druidcloud.io/auth-callback',
    silent_redirect_uri: 'https://site12.druidcloud.io/silent-refresh.html',
    response_type: "code",
